function des = curveDescriptor(inputimage,outputfile,siz,sig1,sig2,ROI,rt,withpadding)
...
% vv(vv<25497)
for ii=6044*2-1%vv;%(vv<22131)%find(missingfiles)%
    %%
    ...
    curveDescriptor(inputfiles{ii},outfile,sprintf('[%d %d %d]',11*ones(1,3)),sprintf('[%f %f %f]',3.4055002*ones(1,3)),sprintf('[%f %f %f]',4.0498447*ones(1,3)),...
